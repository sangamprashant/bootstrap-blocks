  ...
  return (
    <div class="container">
      <div class="row g-0 mt-5 mb-5 height-100 justify-content-center">
        <div class="col-md-8">
          <div
            class={`shadow rounded-3 bg-${
              isDarkMode ? "dark text-white" : "white text-dark"
            } p-4 h-100`}
          >
            <div class="p-3">
              <h3 class="main-heading text-center">Signin To Cever</h3>
              <div class="social-list mt-3 d-flex justify-content-center gap-2">
