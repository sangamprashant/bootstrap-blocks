...
function ProductNightC() {
    const products = [
        {
          image: 'https://www.freepnglogos.com/uploads/plant-png/plant-png-pleasures-helping-others-beautiful-transparent-plants-0.png',
        ...
        {
          image: 'https://www.freepnglogos.com/uploads/plant-png/plants-transparent-png-pictures-icons-and-png-14.png',
          title: 'The Little Botanical Haworthia',
          rating: 5,
          reviews: 3,
          price: 10.99,
        ...
        {
          image: 'https://www.freepnglogos.com/uploads/plant-png/plant-png-plants-png-transparent-images-png-only-27.png',
          title: 'The Little Botanical Haworthia',
          rating: 5,
          reviews: 3,
          price: 10.99,
      ...
      return (
        <div className="wrapper rounded bg-white">
          <div className="d-flex align-items-center justify-content-end px-sm-3 pt-3 px-1">
            <div className="text-muted">Items per page (<b>53 items</b>)</div>
              ...
              >
                <div className="card">
                  ...
                  <div className="d-flex justify-content-center">
                    <img src={product.image} className="product" alt={product.title} />
                  </div>
                  <b className="px-2">
                  ...
                  <div className="d-flex align-items-center justify-content-start rating border-top border-bottom py-2">
                    ...
                    <div className="px-lg-2 px-1">
                      {[...Array(product.rating)].map((_, i) => (
                        <span key={i} className="fas fa-star" />
                      ))}
                  ...
                  <div className="d-flex align-items-center justify-content-between py-2 px-3">
                    ...
                    <div>
                      <button className="btn btn-dark text-uppercase">Buy Now</button>
                    </div>
                  </div>
                </div>
              </div>
