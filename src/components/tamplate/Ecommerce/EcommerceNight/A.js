...
function EcommerceNightA() {
  ...
  return (
    <section className="h-100 dg-dark" >
                ...
                <div className="row">
                  <div className="col-lg-7">
                    ...
                    {products.map((product, index) => (
                      <div className="card mb-3" key={index} style={{backgroundColor:"#696969", color:"white"}}>
...
export default EcommerceNightA;
